...
# with command line options: -s GEN,SIM,DIGI,L1,DIGI2RAW,RAW2DIGI,L1Reco,RECO --evt_type MinBias_13TeV_pythia8_TuneCUETP8M1_cfi --conditions auto:run2_mc --era Run2_2016 --fileout file:GENSIMRECO_MinBias.root --python_filename=Phase0_MinBias_cfg.py --runUnscheduled -n 10
...
if load2DTemplate:
	process.TemplatesReader = cms.ESSource("PoolDBESSource",
		...
		connect = cms.string('sqlite_file:/afs/cern.ch/user/j/jkarancs/public/DB/Phase0/2014_07_17/siPixel2DTemplates38T_IOV5.db'))
