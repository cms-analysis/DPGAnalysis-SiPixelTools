...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
    ...
    connect = cms.string("sqlite_file:SiPixelLorentzAngle_fromAlignment_phase1_mc_v1.db"),
...
# common input for all rings 
    bPixLorentzAnglePerTesla = cms.untracked.double(0.0),
    fPixLorentzAnglePerTesla = cms.untracked.double(0.0),
