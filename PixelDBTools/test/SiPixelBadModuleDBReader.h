#ifndef SiPixelBadModuleDBReader_H
#define SiPixelBadModuleDBReader_H
...
class SiPixelBadModuleDBReader : public edm::EDAnalyzer {

 public:
  explicit SiPixelBadModuleDBReader( const edm::ParameterSet& );
  ~SiPixelBadModuleDBReader();
