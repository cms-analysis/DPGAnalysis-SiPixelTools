    ...
    if (n3*n2*n4>0){
...

      {
        ...
        if( pt > 4 ) {
          ...
          if( abs( phi4 - phiN4 ) < pihalf ){ // outward facing module
            if(zPXB4 > 0) g512_out_zplus->Fill( f4*wt, dca4*1E4 );
            else g512_out_zminus->Fill( f4*wt, dca4*1E4 );
          }
          else{
            if(zPXB4 > 0) g512_in_zplus->Fill( f4*wt, dca4*1E4 );
            else g512_in_zminus->Fill( f4*wt, dca4*1E4 );
          }
  ...
  */
          ...
          if( abs( phi3 - phiN3 ) < pihalf ) {
            ...
            if (lape.valid()) {
              ...
              if( myCounters::neve < 10 ) cout<<" lape invalid?"<<endl;
            }
          }
        ...
        // residual profiles: alignment check
    	  ...
    	  if( pt > 4 ) {
    	    ...
    	    if( abs( phi3 - phiN3 ) < pihalf ){ // outward facing module
    	      if(zPXB3 > 0) hg412_out_zplus->Fill( f3*wt, dca3*1E4 );
            else hg412_out_zminus->Fill( f3*wt, dca3*1E4 );
          }
          else{
            if(zPXB3 > 0) hg412_in_zplus->Fill( f3*wt, dca3*1E4 );
            else hg412_in_zminus->Fill( f3*wt, dca3*1E4 );
          }
