...
process = cms.Process("SiPixelPixels")
...
# 
process.GlobalTag = GlobalTag(process.GlobalTag, 'auto:phase1_2017_design', '') # phase 1 
...
process.test = cms.EDAnalyzer( "SiPixelPixels",
